...
//        $('#ajax-content').html(default_content);
//    } else {
//        console.log('.sidebar [href="'+hash+'"][data-toggle=ajax]');
...
var handleSidebarAjaxClick = function() {
    ...
    $(document).on('click', '.sidebar [data-toggle=ajax], #ajax-content a[data-pjax], .pagination a', function(event) {
    ...
    $(document).on('pjax:success', function() {
        //$(document).on('click', '#ajax-content a[data-pjax], .pagination a', function(event) {
        //    var container = $('#ajax-content');
        //    $.pjax.click(event, {container: container})
        //});
        //
...
var handleNotification = function(title, text, sticky) {
    $.gritter.add({
        title: title,
        text: text,
        sticky: sticky,
...
var handleParseNotification = function(message) {
    handleNotification(message.title, message.text, message.sticky);
}

var handleErrorNotification = function (message) {
    handleNotification('Oops.. Sesuatu yang tidak diinginkan!', message, true);
};
