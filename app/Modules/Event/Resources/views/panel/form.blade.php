...
{!! Former::text('tempat') !!}
{!! Former::text('mulai_tanggal')->class('form-control datepicker-autoClose')->append(Icon::calendar()) !!}
...
{!! Former::textarea('info')->data_provide('markdown')->data_iconlibrary("fa")->data_resize('vertical') !!}
{!! Former::text('pj') !!}
