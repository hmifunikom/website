    ...
    <table class="twelve columns">
        <tr>
            <td>
                ...
                <p class="m-b-10">Terima kasih atas transaksi anda. Berikut adalah rincian transaksi : </p>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <p class="last">
                    Mohon untuk melakukan pembayaran dilakukan max seminggu setelah tanggal invoice dan H-2 dari tanggal acara.
                    <br><br>
                    Terima kasih,<br>
                    HMIF Unikom
                </p>
