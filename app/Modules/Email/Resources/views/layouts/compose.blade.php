...
<head>
    ...
    <style type="text/css">
        ...
        ********************************/
        ...
        table.table.table-invoice td, table.table.table-invoice th {
                                        ...
                                        <tr>
                                            <td class="wrapper">
                                                ...
                                                <table class="six columns">
                                                    <tr>
                                                        <td>
                                                            <a href="{{ env('SITE_URL') }}"><img src="{{ asset_version('assets/images/logo-mail.png') }}" /></a>
                                                        </td>
                    ...
                    <table class="container content dark-theme">
                        <tr>
                            <td>
                                ...
                                <!-- end row -->
                                <!-- begin row -->
                                <table class="row" style="background:#111">
                                    <tr>
                                        <!-- begin wrapper -->
                                        <td class="wrapper">
                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td>
                                                        <h4>HMIF Unikom</h4>
                                                        <p>
                                                            R.4416 - Jl. Dipati Ukur No. 112-114-116<br>
                                                            Bandung 40132<br>
                                                            T: 022 96072227
                                                            E: <a href="mailto:humas@hmifunikom.org">humas@hmifunikom.org</a>
                                                        </p>
                                                    </td>
                                                    <td class="text-right">
                                                        <h4 class="text-right">Follow us</h4>
                                                        <a href="https://www.facebook.com/hmifunikom"><img src="{{ asset_version('assets/images/facebook-mail.png') }}" width="16px" /></a>
                                                        <a href="https://twitter.com/hmifunikom"><img src="{{ asset_version('assets/images/twitter-mail.png') }}" /></a>
                                                        <a href="https://instagram.com/hmifunikom/"><img src="{{ asset_version('assets/images/instagram-mail.png') }}" /></a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <!-- end twelve columns -->
